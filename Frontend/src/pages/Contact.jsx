...
function Contact() {
  return (
    <div className='min-h-[80vh] mt-24 md:mt-28 ml-0 sm:ml-36 md:ml-44 lg:ml-56 px-4 sm:px-8'>
      <div className='text-2xl sm:text-3xl'>
        <Title text1={"CONTACT"} text2={"US"} />
      </div>

      <div className="flex flex-col lg:flex-row items-center justify-between mt-10 mx-auto px-0 md:px-8 gap-12">
        ...
        <div class="w-full flex justify-center">
          <form className="w-[90%] sm:w-full px-0 lg:px-6" name="contactUS" netlify>

            <p className="text-sm sm:text-base text-[#b6bee5] dark:text-[#b6bee5] mb-5">New projects, freelance inquiry or even a coffee.</p>
