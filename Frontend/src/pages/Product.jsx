        ...
        <div className='flex justify-start items-start bg-[#181e33]/50 border border-[#b6bee5]/50 rounded-lg gap-10 h-[90vh] px-10 py-16'>
          ...
          <div className='h-[80%] w-[50%] flex flex-col gap-3 pr-5'>
            ...
            <div className='flex gap-5 mt-4'>
              ...
              <button onClick={() => addToCart(productData._id)} className='bg-[#fff] active:bg-gray-400 text-[#0d1224] text-xl rounded-full px-6 py-3 w-max font-medium font-sans flex gap-2 hover:-translate-y-1 transition-all duration-200 ease-in-out'>
