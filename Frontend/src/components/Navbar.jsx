...
function Navbar() {
  ...
  return (
    <div className='px-4 sm:px-6 md:px-10 py-5 h-[10vh] bg-[#0d1224] text-[#fff] flex justify-between items-center border-b border-b-[#b6bee5]/50 fixed top-0 w-full z-10'>
      <div className='absolute top-0 -translate-x-1/2 left-1/2 bg-gradient-to-r from-pink-600 to-red-500 text-[#fff] z-[100] px-1 sm:px-3 md:px-6 py-1 text-[10px] md:text-sm transition-all duration-150 ease-in-out'><span className='font-bold'>Note: </span>The website is currently in developing phase...</div>
      ...
      <div className='flex gap-2 sm:gap-4 md:gap-8 items-center justify-center'>
        ...
        <button onClick={() => setProfileBtn(true)} className='group relative p-1.5 sm:p-2 rounded-full hover:bg-[#181e33] cursor-pointer transition-all duration-300 hover:shadow-[0_0_10px_rgba(38,255,226,0.1)] active:scale-95'>
          ...
          {/* dropdown menu for logedin user */}
          {
            token && 
