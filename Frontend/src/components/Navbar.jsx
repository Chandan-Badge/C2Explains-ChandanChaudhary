...
function Navbar() {
  ...
  return (
    <div className='px-4 sm:px-6 md:px-10 py-5 h-[10vh] bg-[#0d1224] text-[#fff] flex justify-between items-center border-b border-b-[#b6bee5]/50 fixed top-0 w-full z-10'>
      <div className='absolute top-0 -translate-x-1/2 left-1/2 bg-red-700 text-[#fff] z-[100] px-6 py-1 text-xs sm:text-sm rounded'>Note: This project is currently in developing phase...</div>
