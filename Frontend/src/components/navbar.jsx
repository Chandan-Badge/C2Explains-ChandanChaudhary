      ...
      <div className='flex gap-5 sm:gap-8 items-center justify-center'>
        ...
        <Link to="/cart" className='group relative p-1.5 sm:p-2 rounded-full hover:bg-[#181e33] cursor-pointer transition-all duration-300 hover:shadow-[0_0_10px_rgba(38,255,226,0.1)] active:scale-95'>
          ...
          <div className='relative'>
            ...
            <p className='absolute -right-[2px] -bottom-[2px] w-4 text-center landing-4 text-black bg-white aspect-square rounded-full text-[8px] flex justify-center items-center'>{getCartCount()}</p>
          </div>
