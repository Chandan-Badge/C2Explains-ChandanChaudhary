    ...
    <div className='px-10 py-3 text-[#fff] flex justify-between items-center'>
      ...
      <div className='flex gap-6 items-center justify-center'>
        ...
        <Link to="/cart" className='relative'>
          ...
          <p className='absolute -right-1 -bottom-1 w-4 text-center landing-4 text-black bg-white aspect-square rounded-full text-[8px] flex justify-center items-center'>10</p>
        </Link>
