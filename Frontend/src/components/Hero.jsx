...
function Hero() {
  return (
    <div className='text-[#fff] flex flex-col items-center justify-center gap-4 mt-32 md:mt-40'>
      ...
      <div className='max-w-[80vw] border border-[#b6bee5]/50 text-[#b6bee5] bg-[#181e33] text-xs md:text-sm py-1.5 px-4 rounded-full flex items-center justify-center group'>
        <p className=''>🎉 Introducing my latest Development Projects.</p>
      ...
      <div className='flex flex-col md:flex-row justify-center items-center gap-4 md:gap-8 lg:gap-20 mt-6 lg:mt-10 text-sm sm:text-base'>
        <button className='border border-[#b6bee5]/50 hover:border-[#26ffe3] text-[#b6bee5] hover:text-gray-200 bg-[#181e33] py-2 px-12 md:px-8 lg:px-16 rounded-full flex items-center gap-1 md:gap-3 group transition-all ease-in-out duration-200'>
          Browse Components
