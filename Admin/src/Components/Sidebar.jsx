  ...
  return (
    <div className='w-[18%] min-h-screen border-r-2 border-r-gray-600'>
      <div className='admin-sidebar flex flex-col gap-4 pt-6 pl-[20%] text-base'>
        ...
        <NavLink to={"/add"} className="flex items-center gap-3 hover:bg-gray-900 border border-gray-500 border-r-0 px-3 py-2 rounded-l">
        ...
        <NavLink to={"/list"} className="flex items-center gap-3 hover:bg-gray-900 border border-gray-500 border-r-0 px-3 py-2 rounded-l">
        ...
        <NavLink to={"/orders"} className="flex items-center gap-3 hover:bg-gray-900 border border-gray-500 border-r-0 px-3 py-2 rounded-l">
